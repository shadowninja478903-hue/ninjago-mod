        ...
        switch (i) {
            case 0 -> {
                ...
                l.getEntitiesOfClass(LivingEntity.class, box(p,r), e->e!=p).forEach(e->{
                    e.hurt(l.damageSources().playerAttack(p), 60f * dmg);
            ...
            case 2 -> {
                ...
                l.getEntitiesOfClass(LivingEntity.class, box(p,r), e->e!=p).forEach(e->{
                    ...
                    e.hurt(l.damageSources().playerAttack(p), 50f * dmg);
                });
            ...
            case 3 -> {
                ...
                l.getEntitiesOfClass(LivingEntity.class, box(p,r), e->e!=p).forEach(e->{
                    ...
                    if (full) e.hurt(l.damageSources().playerAttack(p), 30f);
                });
        ...
        switch (i) {
            ...
            case 1 -> {
                ...
                l.getEntitiesOfClass(LivingEntity.class, box(p,r), e->e!=p).forEach(e->{
                    ...
                    if (full) e.hurt(l.damageSources().freeze(), 35f);
                });
            ...
            case 2 -> {
                ...
                l.getEntitiesOfClass(LivingEntity.class, box(p,r), e->e!=p).forEach(e->{
                    e.hurt(l.damageSources().freeze(), 55f * dmg);
        ...
        switch (i) {
            case 0 -> {
                ...
                if (full) l.getEntitiesOfClass(LivingEntity.class, box(p, 3), e->e!=p).forEach(e->{
                    e.hurt(l.damageSources().playerAttack(p), 40f);
            ...
            case 1 -> {
                ...
                l.getEntitiesOfClass(LivingEntity.class, box(p,r), e->e!=p).forEach(e->{
                    e.hurt(l.damageSources().playerAttack(p), 80f * dmg);
    ...
    private void activateLightning(Player p, Level l, int i, float dmg, boolean full) {
        switch (i) {
            ...
            case 3 -> {
                double r = full ? 9.0 : 6.0;
                l.getEntitiesOfClass(LivingEntity.class, box(p,r), e->e!=p).forEach(e->{
                    e.hurt(l.damageSources().playerAttack(p), 65f * dmg);
                    e.addEffect(new MobEffectInstance(MobEffects.WEAKNESS, 100, full?2:1));
        ...
        switch (i) {
            ...
            case 3 -> {
                ...
                l.getEntitiesOfClass(LivingEntity.class, box(p,r), e->e!=p).forEach(e->{
                    ...
                    e.addEffect(new MobEffectInstance(MobEffects.POISON, full?400:200, full?4:2));
                    e.hurt(l.damageSources().playerAttack(p), full?40f:20f);
